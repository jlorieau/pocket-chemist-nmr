"""
Methods for loading and writing data in NMRPipe format.

Copied and modified from nmrglue:
- https://github.com/jjhelmus/nmrglue/blob/master/nmrglue/fileio/pipe.py

NMRPipe FDATA value assignments:
- http://rmni.iqfr.csic.es/HTML-manuals/nmrpipe-manual/fdatap.html
"""
